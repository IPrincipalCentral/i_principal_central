...
i["i_list_of_unity_in_i_unity"] = i["i_class"].i_get_quanity_from_unity(i_unity="Power")
...
i["i_list_of_unity_in_i_unity_from_folder"] = i["i_class"].i_get_quanity_of_unity_from_folder(i_unity="Power", i_folder=os.path.join(os.getcwd(), "i", "i_unity"))

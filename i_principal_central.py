...
if (i["i am you"] == True):
    ...
    print("finish .")
                ...
                i_self.i["i_file"] = os.path.join(i_self.i["i_i_main"], "i_Economic_Partner_official_receiver_0.py")
                ...
                i_self.i["i_file"] = os.path.join(i_self.i["i_i_main"], "i_Economic_Partner_official_sender_0.py")
                ...
                i_self.i["i_path_of_image-s_of_i_money"] = os.path.join(i_self.i["i_cwd"], "i_folder_of_i_principal_central", "i_folder_of_image_of_i_money_1")
                ...
                i_self.i["i_path_of_image-s_of_i_unity"] = os.path.join(i_self.i["i_cwd"], "i_folder_of_i_principal_central", "i_folder_of_image_i_unity_1")
    ...
    def i_get_list_of_i_unity(i_self):
        ...
        if ((i_self.i["i am you"] == True) and (i_self.i["i develope"] == True)):
            ...
            i_self.i["i_path_of_image-s_of_i_unity"] = os.path.join(os.getcwd(), "i_folder_of_i_principal_central", "i_folder_of_image_i_unity_1")
    ...
    def i_get_list_of_i_money(i_self):
        ...
        if ((i_self.i["i am you"] == True) and (i_self.i["i develope"] == True)):
            ...
            i_self.i["i_path_of_image-s_of_i_money"] = os.path.join(os.getcwd(), "i_folder_of_i_principal_central", "i_folder_of_image_of_i_money_1")
    ...
    def i_print_from_money(i_self, i_unity, i_quantity, i_folder, i_number):
        ...
        if ((i_self.i["i am you"] == True) and (i_self.i["i develope"] == True)):
            ...
            if (i_self.i["i_semaphore_of_get_unity"] == False):

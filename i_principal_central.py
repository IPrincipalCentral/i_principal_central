            ...
            while (i["i_counter"] < i["i_number_of_file-s"]):
                ...
                if (os.path.exists(i["i_file"])):
                    ...
                    try:
                        ...
                        i["i_counter_1"] = int(i_self.i["i_string_of_counte"])
...
if (i["i am you"] == True):
    ...
    def i_print_from_money(i_self, i_quantity, i_unity, i_folder, i_number):
    ...
    def i_print_from_unity(i_self, i_quantity, i_unity, i_folder, i_number):

...
if (i["i am you"] == True):
        ...
        if (o == '+'):
            ...
            if ((t[0]) and (t[1] == 0) and (b_[3] >= 0)):
                ...
                if (int(s) == 0):
                    ...
                    if (not ((my_inferieur_s_n_1(s1=a, s2="0", number_of_digit_after_the_floating_point_=number_of_digit_after_the_floating_point) == True) and ((mod(a=number_v_0, b=2) == 0)))):
    ...
    if __name__ == "__main__":
        ...
        print("oper = '", oper, "' . m = ", m, " . number_of_digit_after_the_floating_point_ = ", number_of_digit_after_the_floating_point, " . time = ", t2 - t1, " . len = ", len(m[1][0]))
